...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            ...
            <li><a href="<?= url('link/' . $data->biolink_block->link_id . '?tab=links') ?>"><?= l('link.breadcrumb_biolink') ?></a> <i class="fa fa-fw fa-angle-right"></i></li>
            <li class="active" aria-current="page">
                <?= l('link.breadcrumb_biolink_block') . ' ' . l('link.statistics.breadcrumb') ?>
            </li>
        </ol>
    </nav>
