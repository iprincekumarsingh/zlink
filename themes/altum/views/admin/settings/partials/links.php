...
<div>
    ...
    <p class="h5"><i class="fab fa-fw fa-google fa-sm mr-1 text-muted"></i> <?= l('admin_settings.links.google_safe_browsing') ?></p>
    ...
    <div class="form-group">
        ...
        <small class="form-text text-muted"><?= l('admin_settings.links.google_safe_browsing_api_key_help') ?></small>
    </div>
