            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            <label for="filters_type" class="small"><?= l('admin_links.filters.type') ?></label>
                            <select name="type" id="filters_type" class="form-control form-control-sm">
                                <option value=""><?= l('global.filters.all') ?></option>
                                <option value="biolink" <?= isset($data->filters->filters['type']) && $data->filters->filters['type'] == 'biolink' ? 'selected="selected"' : null ?>><?= l('admin_links.filters.type_biolink') ?></option>
                                <option value="link" <?= isset($data->filters->filters['type']) && $data->filters->filters['type'] == 'link' ? 'selected="selected"' : null ?>><?= l('admin_links.filters.type_link') ?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="form-control form-control-sm">
                                ...
                                <option value="clicks" <?= $data->filters->order_by == 'clicks' ? 'selected="selected"' : null ?>><?= l('admin_links.filters.order_by_clicks') ?></option>
                            </select>
                        </div>
            ...
            <tr>
                ...
                <td class="text-nowrap">
                    <span class="fa-stack fa-1x" data-toggle="tooltip" title="<?=  l('link.' . $row->type . '.name') ?>">
                        <i class="fas fa-circle fa-stack-2x" style="color: <?= l('link.' . $row->type . '.color') ?>"></i>
                        <i class="fas <?= l('link.' . $row->type . '.icon') ?> fa-stack-1x fa-inverse"></i>
                    </span>
                </td>
                <td class="text-nowrap">
                    <div class="d-flex flex-column">
