        ...
        <div class="row">
            <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0">
                <div>
                    ...
                    <p class="text-muted m-0"><?= l('link.statistics.country_help') ?></p>
                </div>
            </div>
