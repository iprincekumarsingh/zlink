    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-12 col-lg d-flex align-items-center mb-3 mb-lg-0">
                <div>
                    <h3 class="h5"><?= sprintf(l('link.statistics.city'), get_country_from_country_code($data->country_code)) ?></h3>
                    <p class="text-muted m-0"><?= l('link.statistics.city_help') ?></p>
                </div>
            </div>
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-between mb-1">
                    <div class="text-truncate">
                        ...
                        <span class="align-middle"><?= $row->city_name ? $row->city_name : l('link.statistics.city_unknown') ?></span>
                    </div>
