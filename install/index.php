            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <p class="subheader d-flex flex-row">
                        <span class="text-muted">
                            <a href="<?= PRODUCT_URL ?>" target="_blank" class="text-gray-500"><?= PRODUCT_NAME ?></a> by <a href="https://altumco.de/site" target="_blank" class="text-gray-500">Prince Kumar Singh</a>
                        </span>
                </p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col" id="content">
                ...
                <section id="welcome" style="display: none">
                    <h2>Welcome</h2>
                    <p>Thank you for choosing the <a href="https://princekumarsingh.tech" target="_blank">Prince Kumar Singh</a></p>
